...
\part*{Modelo relacional}
	...
	\begin{tikzpicture}[relation/.style={rectangle split, rectangle split parts=#1, rectangle split part align=base, draw, anchor=center, align=center, text height=3mm, text centered}]\hspace*{-0.3cm}
		...
		\nodepart{two}   nombre\_departamento
		\nodepart{three} NSS\_director};
		...
		\begin{comment}
			...
			\draw[-latex] (niños.five south) -- ++(-0,-0.25) -| ($(niños.five south) + (1.5 ,0)$) |- ($(elfos.one south) + (0, -0.3)$) -| ($(elfos.one south) + (0,0)$);
			%
			
			\draw[-latex] (parentesco.one south) -- ++(-0,-0.25) -| ($(parentesco.one south) - (1.3,0)$) |- ($(niños.one south) + (0, -0.5)$) -| ($(niños.one south) + (0,0)$);
			
			\draw[-latex] (parentesco.one south) -- ++(-0,-0.25) -| ($(parentesco.one south) - (1.3,0)$) |- ($(niños.two south) + (0, -0.5)$) -| ($(niños.two south) + (0,0)$);
